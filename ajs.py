...
wait = {
    ...
    "sticker":False,
    "selfbot":True,
    "mention":"Cieeee ada jones ngintip...sini masuk siapa tau nyaman 😊",
    "Respontag":"yeeee katauan ngetag..,kode yaa",
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                if msg.to in protectqr: md+="❧Protectinvite「ON」\n"
...
#===========BOT UPDATE============#
                        elif cmd == "tagall","absen" or text.lower() == 'nah':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               start = time.time() / 3
                               time.sleep(0.002)
                               cl.sendMessage(msg.to, "sabarr brooo")
